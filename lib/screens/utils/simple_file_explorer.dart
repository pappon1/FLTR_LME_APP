...
class _SimpleFileExplorerState extends State<SimpleFileExplorer> {
  ...
  Future<void> _refreshFolderFiles() async {
    ...
    try {
      final List<FileSystemEntity> entities = await _currentDirectory
          .list(followLinks: false)
          .toList();
      entities.sort((a, b) {
      ...
      return Center(
        child: Column(
          ...
          children: [
            ...
            TextButton(onPressed: _startSmartScan, child: const Text('Rescan')),
          ],
        ),
      );
    }
      ...
      child: GridView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          final isVideo =
              ...
              widget.allowedExtensions.contains('mkv');
          final isImage =
        ...
        Container(
          ...
          child: Row(
            children: [
              ...
              Expanded(
                child: Text(
                  _currentDirectory.path.replaceAll(
                    '/storage/emulated/0',
                    'Internal',
                  ),
            ...
            itemBuilder: (context, index) {
              ...
              return ListTile(
                leading: Icon(
                  ...
                  color: isDir ? Colors.orange : _getFileColor(name),
                ),
                title: Text(name),
