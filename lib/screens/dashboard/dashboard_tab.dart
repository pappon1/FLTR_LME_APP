      ...
      unawaited(
        showDialog(
          ...
          builder: (context) => AlertDialog(
            ...
            content: const Text(
              'To receive alerts about new messages, payments, and downloads, please enable notifications.',
            ),
            actions: [
              TextButton(
            ...
            builder: (context, notifProvider, _) {
              ...
              return Padding(
                ...
                child: IconButton(
                        ...
                        shouldAnimate
                            ? Animate(onPlay: (c) => c.repeat()).custom(
                                ...
                                builder: (context, value, child) {
                                  ...
                                  final color = isPhase1
                                      ? const Color(0xFFFF0000)
                                      : const Color(0xFFFFD700);
                                  final shadowColor = isPhase1
                                      ? Colors.redAccent.withAlpha(128)
                                      : Colors.yellowAccent.withAlpha(128);
                                  return Container(
                                    decoration: BoxDecoration(
                                      shape: BoxShape.circle,
                                      boxShadow: [
                  ...
                  tooltip: hasUnread
                      ? '${notifProvider.totalUnread} New Notifications'
                      : 'Notifications',
                ),
              );
            },
        ...
        builder: (context, provider, child) {
          ...
          return RefreshIndicator(
            ...
            child: ListView(
              ...
              padding: EdgeInsets
                  .zero, // Removed global padding for edge-to-edge content
              children: [
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: List.generate(
                          provider.popularCourses.length,
                          (index) {
                            final isSelected =
                                (_currentPage %
                                    provider.popularCourses.length) ==
                            ...
                            child: GestureDetector(
                              onTap: () {
                                Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                    builder: (context) =>
                                        const StudentsTab(showOnlyBuyers: true),
                                  ),
                                );
                              },
                              child:
                            ...
                            child: GestureDetector(
                              onTap: () {
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (_) => const RevenueDetailScreen(),
                                  ),
                                );
                              },
                              child:
                            ...
                            child: GestureDetector(
                              onTap: () {
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (_) => const ContactLinksScreen(),
                                  ),
                                );
                              },
                              child:
                                  const StatCard(
                                        ...
                                        icon: FontAwesomeIcons
                                            .shareNodes, // Represents sharing/socials
                                        gradient: AppTheme
                                            .primaryGradient, // Use primary brand gradient
