    ...
    if (picked != null) {
      ...
      if (_scheduledTime == null) {
        ...
        if (mounted)
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(
              content: Text('Schedule canceled (Time not selected).'),
            ),
          );
      }
    }
  ...
  Future<void> _processNotification() async {
    ...
    if (_isScheduled && (_scheduledDate == null || _scheduledTime == null)) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text(
            'Please select both Date and Time for scheduling or turn off Schedule mode.',
          ),
          backgroundColor: Colors.red,
        ),
      );
    ...
    if ((_selectedAction == 'Specific Course' ||
            _selectedAction == 'Custom URL') &&
        _actionValueController.text.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Please select a Course or enter a URL.'),
          backgroundColor: Colors.red,
        ),
      );
      return;
    ...
    try {
      ...
      final SnackBarAction action = SnackBarAction(
        label: 'Retry',
        onPressed: _processNotification,
      );
      if (mounted)
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
    ...
    if ((_selectedAudience == 'Select Users' || _selectedAudience.isEmpty) &&
    ...
    try {
      ...
      final notificationData = {
        ...
        'imageUrl': imageUrl,
        'targetAudience': _selectedCourseIds.isNotEmpty
            ? 'course_specific'
            : _selectedAudience,
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              Text(
                                'COURSES (${tempCourseIds.length} Selected)',
                                style: TextStyle(
                                  color: Colors.grey[600],
                                  fontWeight: FontWeight.bold,
                                  fontSize: 13,
                                  ...
                                  onChanged: (val) {
                                    setSheetState(() {
                                      if (val == true) {
                                        ...
                                        tempSegment =
                                            null; // Clear segment if specific course selected
                                      } else {
                                  ...
                                  if (tempSegment == null &&
                                    ...
                                    setState(() {
                                      ...
                                      if (tempSegment != null) {
                                        ...
                                        if (tempSegment == 'new')
                                          _selectedAudience =
                                              'All New App Downloads';
                                        if (tempSegment == 'non_purchasers')
                                          _selectedAudience =
                                        ...
                                        if (tempCourseIds.length == 1) {
                                          ...
                                          _selectedAudience =
                                              '${tempCourseIds.length} Courses Selected';
                                        }
                                      }
                                    });
                                  }
                          ...
                          child: Column(
                            children: [
                              ...
                              const RadioListTile<String>(
                                ...
                                subtitle: Text(
                                  'Redirects to a specific course detail',
                                ),
                              ...
                              const RadioListTile<String>(
                                ...
                                subtitle: Text(
                                  'Opens a Weblink or YouTube Video',
                                ),
                                value: 'Custom URL',
                                activeColor: Colors.orange,
                                contentPadding: EdgeInsets.zero,
          ...
          Container(
            ...
            child: ListTile(
              onTap: () => Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => const SentHistoryScreen(),
                ),
              ),
              ...
              child: Column(
                ...
                children: [
                  ...
                  GestureDetector(
                    ...
                    onLongPressDown: (_) {
                      if (_selectedImage != null && !_isSending)
                        _startHoldTimer();
                    },
            ...
            timer ??= Timer.periodic(const Duration(seconds: 1), (t) {
              if (secondsRemaining > 1) {
                ...
                ScaffoldMessenger.of(this.context).showSnackBar(
                  // Use 'this.context' for the parent scaffold
                  const SnackBar(
  ...
  Widget _buildTextTools(
    ...
    return PopupMenuButton<String>(
        ...
        switch (value) {
          ...
          case 'sentence':
            if (text.isNotEmpty) {
              newText =
                  text[0].toUpperCase() +
                  text.substring(1).toLowerCase(); // Basic sentence case
            }
            break;
        }
      ...
      itemBuilder: (context) => [
        const PopupMenuItem(
          value: 'title',
          child: Text('Capitalize Words (Title Case)'),
        ),
          ...
          child: Material(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                color: const Color(
                  0xFF202124,
                ), // Approx Android Dark Notif Color
                borderRadius: BorderRadius.circular(3.0),
                boxShadow: [
                  BoxShadow(
