...
class _SentHistoryScreenState extends State<SentHistoryScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Sent History'),
        centerTitle: true,
      ),
      body: RefreshIndicator(
        onRefresh: () async {
          setState(() => _isRefreshing = true);
          await Future.delayed(const Duration(seconds: 1)); // Simulating refresh for UX
              ...
              child: SingleChildScrollView( 
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    FaIcon(FontAwesomeIcons.clockRotateLeft, size: 64, color: Colors.grey[300]),
                    const SizedBox(height: 16),
                    Text('No notifications sent yet.', style: AppTheme.bodyLarge(context)),
                  ],
                ),
              ),
            );
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(data['message'] ?? '', style: AppTheme.bodyMedium(context)),
