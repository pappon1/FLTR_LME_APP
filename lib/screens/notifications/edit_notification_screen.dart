                            ...
                            return Column(
                              children: snapshot.data!.docs.map((doc) {
                                ...
                                return CheckboxListTile(
                                  title: Text(
                                    (doc.data() as Map)['title'] ?? 'Untitled',
                                  ),
                                  value: isSelected,
                                  activeColor: Colors.red,
                                  onChanged: (val) {
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: () {
                            setState(() {
                              ...
                              if (tempSegment != null) {
                                if (tempSegment == 'all')
                                  _selectedAudience = 'All App Downloads';
                                if (tempSegment == 'new')
                                  _selectedAudience = 'All New App Downloads';
                    ...
                    child: ListView(
                      ...
                      children: [
                        RadioGroup<String>(
                          ...
                          onChanged: (v) =>
                              setSheetState(() => tempAction = v.toString()),
                          child: Column(
                            children: [
                              const RadioListTile(
