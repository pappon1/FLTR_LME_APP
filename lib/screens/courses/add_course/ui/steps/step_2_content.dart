          ...
          slivers: [
            ...
            SliverPadding(
              ...
              padding: EdgeInsets.only(
                ...
                top: (state.isSelectionMode || state.isDragModeActive)
                    ? 16.0
                    : 0,
              ),
                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              state.courseContentError
                                  ? 'Add at least one content to proceed *'
                                  : 'No content added yet',
                              style: TextStyle(
                                color: state.courseContentError
                                    ? Colors.red
                                    : Colors.grey.shade400,
                                fontWeight: state.courseContentError
                                    ? FontWeight.bold
                                    : FontWeight.normal,
                              ),
                            ),
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return CourseContentListItem(
                          ...
                          onEnterSelectionMode: () =>
                              logic.enterSelectionMode(index),
                          onStartHold: () =>
                              logic.startHoldTimer(logic.enterDragMode),
                          ...
                          onRemove: () => contentManager.confirmRemoveContent(
                            context,
                            index,
                          ),
                          onAddThumbnail: () =>
                              ContentDialogs.showThumbnailManagerDialog(
                                context: context,
                                initialThumbnail: item['thumbnail'],
                                onSave: (newThumb) {
                                  state.courseContents[index]['thumbnail'] =
                                      newThumb;
                                  state.updateState();
                                  logic.draftManager.saveCourseDraft();
                                },
