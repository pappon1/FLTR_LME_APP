                        ...
                        border: Border.all(
                          color: state.thumbnailImage == null
                              ? (state.thumbnailError
                                  ...
                                  : Theme.of(context).dividerColor.withOpacity(UIConstants.borderOpacity))
                  ...
                  ...state.faqControllers.asMap().entries.map((entry) {
                    ...
                    return Container(
                      ...
                      decoration: BoxDecoration(
                        color: Colors.transparent,
                        border: Border.all(
                          color: Theme.of(context).dividerColor.withOpacity(UIConstants.borderOpacity),
                        ),
                        borderRadius: BorderRadius.circular(UIConstants.globalRadius),
                      ),
                      child: Column(
      ...
      decoration: InputDecoration(
        ...
        enabledBorder: OutlineInputBorder(
          ...
          borderSide: BorderSide(
            color: hasError ? Colors.red : Theme.of(context).dividerColor.withOpacity(UIConstants.borderOpacity),
          ),
        ),
