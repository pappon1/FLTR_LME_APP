...
class _AddVideoScreenState extends State<AddVideoScreen> {
  ...
  Future<void> _uploadAndSave() async {
    ...
    try {
      ...
      // 3. Upload Video using TUS (Bunny Stream)
      setState(() => _uploadStatus = 'Uploading video (TUS)...');
      final videoUploader = TusUploader(
        apiKey: ConfigService().bunnyStreamKey,
        libraryId: ConfigService().bunnyLibraryId,
        videoId: '', // Server-generated
        collectionId: null, // Standalone, or you could pass one if needed
      );

      final String videoUuid = await videoUploader.upload(
      ...
      final String videoUrl = "https://${ConfigService().bunnyStreamCdnHost}/$videoUuid/playlist.m3u8";
      ...
      final video = VideoModel(
        ...
        videoUrl: videoUrl, // Will be nested in media block by toMap
        thumbnailUrl: thumbnailUrl.isNotEmpty 
            ? thumbnailUrl 
            : videoUrl.replaceAll('playlist.m3u8', 'thumbnail.jpg'),
        ...
        isFree: _isFree,
        isPublished: true,
        createdAt: DateTime.now(), // Firestore will use server timestamp if we set it in toMap
      );
