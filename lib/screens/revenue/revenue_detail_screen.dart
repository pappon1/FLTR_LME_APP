...
class _RevenueDetailScreenState extends State<RevenueDetailScreen> {
  ...
  Future<void> _fetchData() async {
    ...
    try {
      ...
      final courseSnaps = await FirebaseFirestore.instance
          .collection('courses')
          .get();
      _coursePrices = {
      ...
      for (var doc in enrollments.docs) {
        ...
        final price =
            _coursePrices[courseId] ?? 0.0; // Assume stored price or fetch
      ...
      _chartData = sortedMs.map((ms) {
        ...
        return {
          'label':
              (_selectedFilter == '1 Year' || _selectedFilter == 'Lifetime')
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: ListView(
                        ...
                        children: ['7 Days', '1 Month', '1 Year', 'Lifetime']
                            .map((filter) {
                    ...
                    _recentTransactions.isEmpty
                        ...
                        : ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              final data =
                                  _recentTransactions[index].data()
                                      as Map<String, dynamic>;
                              final price =
                                  _coursePrices[data['courseId']] ?? 0.0;
                              final date =
                                  (data['enrolledAt'] as Timestamp?)
                                      ?.toDate() ??
                                  DateTime.now();
