...
class RazorpaySettlementsScreen extends StatefulWidget {
  ...
  @override
  State<RazorpaySettlementsScreen> createState() =>
      _RazorpaySettlementsScreenState();
}
...
class _RazorpaySettlementsScreenState extends State<RazorpaySettlementsScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: _isLoading
          ? const SimpleShimmerList(itemHeight: 80.0)
          : _error != null
          ? Center(
              child: Padding(
          ...
          : ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                final amount =
                    (item['amount'] ?? 0) / 100; // Razorpay is in paise
                ...
                return Card(
                  ...
                  child: ListTile(
                    leading: CircleAvatar(
                      backgroundColor: status == 'processed'
