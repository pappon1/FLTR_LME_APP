  ...
  Widget build(BuildContext context) {
    return Card(
      ...
      child: ListTile(
                ...
                children: [
                   Padding(
                    ...
                    child: FaIcon(
                      ...
                      size: 11,
                      color: Theme.of(context).brightness == Brightness.dark ? Colors.greenAccent : Colors.green[700],
                    ),
                  ),
                  const SizedBox(width: 8),
                  Expanded(
        ...
        onTap: () {
          Navigator.push(context, MaterialPageRoute(builder: (_) => UserProfileScreen(student: student)));
        },
      ),
    );
  }
