...
class DummyCourseData {
  static final CourseModel sampleCourse = CourseModel(
    ...
    price: 15000,
    discountPrice: 12499,
    description: 'This is a comprehensive masterclass on micro-soldering. Learn how to fix dead motherboards, replace ICs, and reball CPUs like a professional engineer. We cover everything from basic soldering iron tips to advanced hot air station techniques.\n\nKey Learings:\n• Component Identification\n• IC Reballing\n• Jumper Wire Techniques\n• Schematic Analysis',
    ...
    faqs: [
      {
        ...
        'answer': 'While we start from basics, having some knowledge of electronics will help you progress faster.'
      },
      {
        'question': 'Will I get tools with the course?',
        'answer': 'No, tools are not included, but we provide a list of recommended tools and where to buy them.'
      }
    ],
    contents: [
      {
